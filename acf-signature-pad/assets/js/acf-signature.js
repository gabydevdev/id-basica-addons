...
!function() {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var signature_pad__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);

function initSignatureField(wrapper) {
  var canvas = wrapper.querySelector('.acf-signature-canvas');
  var input = wrapper.querySelector('.acf-signature-input');
  var clearBtn = wrapper.querySelector('.acf-signature-clear');
...
/******/ })()
;
//# sourceMappingURL=acf-signature.js.map