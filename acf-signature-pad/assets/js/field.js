/**
 * Included when signature_pad fields are rendered for editing by publishers.
 */
(function ($) {
	...
	if (typeof acf.add_action !== 'undefined') {
		 ...
		 */
		acf.add_action('ready_field/type=signature_pad', initialize_field);
		acf.add_action('append_field/type=signature_pad', initialize_field);
	}
})(jQuery);
